...
int main(int argc, char **argv){
    ...
    double erreur_infty;
    // Fichiers
    nom_fichier_bin = "Textes/5/resultats.bin";
    const char *entete;
    double resultats[8];
    ...
    // ======================================================
    printf("------------------------------------------------------------\n");
    printf("Exécution de version 5 : Schéma semi-implicite, bibliothèque cholmod\n");
    cholmod_start(&c);
